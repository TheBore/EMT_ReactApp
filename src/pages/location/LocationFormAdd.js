...
export default function LocationFormAdd (props) {
    ...
    return (
        ...
        >
            <Box sx={style}>
                ...
                <TextField style={{width: '100%'}} id="id" label="Id" variant="standard" />
                <TextField style={{width: '100%'}} id="address" label="Address" variant="standard" />
                <TextField style={{width: '100%'}} id="estates_number" label="Number of estates" variant="standard" />
                <TextField style={{width: '100%'}} id="ten_km_population" label="Ten km population" variant="standard" />
                <TextField style={{width: '100%'}} id="sea_level" label="Sea level" variant="standard" />
